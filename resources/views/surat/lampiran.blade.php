    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 ml-[280px] p-8">
            ...
            <div id="uploadForm" class="bg-white rounded-xl shadow-sm p-6 mb-8 hidden">
                ...
                <form action="{{ route('lampiran.store', $surat->id_surat) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="border rounded-lg p-4">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <form action="{{ route('lampiran.destroy', $lampiran->id_lampiran) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
